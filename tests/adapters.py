...
from cs336_basics.transformer import AdamW, cosine_schedule_with_warmup, gradient_clipping, get_batch, save_checkpoint, load_checkpoint
...
def run_scaled_dot_product_attention(
    ...
    return scaled_dot_product_attention(Q, K, V, mask, is_causal=False)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    return multihead_self_attention_rope(d_model, 
                                    num_heads, 
                                    q_proj_weight, 
                                    k_proj_weight, 
                                    v_proj_weight, 
...
def run_transformer_block(
    ...
    transformer_block = Transformer_block(d_model=d_model, num_heads=num_heads, 
                                          d_ff=d_ff, max_seq_len=max_seq_len, theta= theta
                                    )
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cosine_schedule_with_warmup(it, min_learning_rate, max_learning_rate,warmup_iters, cosine_cycle_iters )
